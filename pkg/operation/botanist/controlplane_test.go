...
var _ = Describe("controlplane", func() {
	...
	DescribeTable("#getResourcesForAPIServer",
		...
		// nodes tests
		Entry("nodes <= 2", 2, "", "400m", "800Mi", "1000m", "1200Mi"),
		Entry("nodes <= 10", 10, "", "500m", "1100Mi", "1200m", "1900Mi"),
		Entry("nodes <= 50", 50, "", "600m", "1600Mi", "1500m", "3900Mi"),
		Entry("nodes <= 100", 100, "", "1000m", "5200Mi", "3000m", "5900Mi"),
		Entry("nodes > 100", 1000, "", "1500m", "5200Mi", "4000m", "7800Mi"),

		// scaling class tests
		Entry("scaling class small", -1, "small", "400m", "800Mi", "1000m", "1200Mi"),
		Entry("scaling class medium", -1, "medium", "500m", "1100Mi", "1200m", "1900Mi"),
		Entry("scaling class large", -1, "large", "600m", "1600Mi", "1500m", "3900Mi"),
		Entry("scaling class xlarge", -1, "xlarge", "1000m", "5200Mi", "3000m", "5900Mi"),
		Entry("scaling class 2xlarge", -1, "2xlarge", "1500m", "5200Mi", "4000m", "7800Mi"),

		// scaling class always decides if provided
		Entry("nodes > 100, scaling class small", 100, "small", "400m", "800Mi", "1000m", "1200Mi"),
		Entry("nodes <= 100, scaling class medium", 100, "medium", "500m", "1100Mi", "1200m", "1900Mi"),
		Entry("nodes <= 50, scaling class large", 50, "large", "600m", "1600Mi", "1500m", "3900Mi"),
		Entry("nodes <= 10, scaling class xlarge", 10, "xlarge", "1000m", "5200Mi", "3000m", "5900Mi"),
		Entry("nodes <= 2, scaling class 2xlarge", 2, "2xlarge", "1500m", "5200Mi", "4000m", "7800Mi"),
	)
